        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-center gap-3">
            {theme.logoUrl ? (
              ...
              <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${primaryColor}22` }}>
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-full whitespace-nowrap text-sm font-medium transition-all duration-200 border ${
                  active ? 'text-white shadow-md transform scale-105' : 'bg-white/90 text-gray-600 hover:bg-white border-gray-200'
                }`}
