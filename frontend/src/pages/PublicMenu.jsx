                ...
                <div className="h-48 w-full bg-gray-200 relative overflow-hidden">
                   ...
                   {!item.available && (
                     <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                       <span className="bg-red-500 text-white px-3 py-1 rounded-full text-sm font-bold">No está diponible</span>
                     </div>
                   )}
                </div>
              )}
      ...
      <footer className="bg-white border-t border-gray-200 mt-12 py-8">
        <div className="max-w-7xl mx-auto px-4 text-center">
             <p className="text-gray-400 text-sm flex items-center justify-center">
               Powered by <i className="fas fa-cloud text-gray-300 mx-1"></i> <span className="font-semibold text-gray-500">LatinNexo 2026</span>
             </p>
        </div>
      </footer>
    </div>
